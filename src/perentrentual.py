...
from src.readers.funding_reader import Current_Futures_Reader, Current_Futures_Data
...
class Funding_Data:
    ...
    def get_data_structure(self):
        self.data_structure = Current_Futures_Data()
    ...
    def get_fresh_data(self):
        self.data = Current_Futures_Reader(self.config).get_data()
        return self.data
